...
from greatagain_parser_naver.parser.model import Article, Comment, CommentsCountHistory, ArticleHistory
...
class Parser(object):
    ...
    async def save_article_history(self, article_history: ArticleHistory):
        await self.repository.save_article_history(article_history)
